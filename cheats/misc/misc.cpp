...
#define VERSION crypt_str("Alphen.cc | ")
...
void misc::ChatSpammer()
{
	...
	{
		crypt_str("Alphen - the best hvh cheat"),
		crypt_str("Get Alphen."),
		crypt_str("Alphen - The resolver craves your head."),
		crypt_str("Go injected Alphen soon"),
	};
